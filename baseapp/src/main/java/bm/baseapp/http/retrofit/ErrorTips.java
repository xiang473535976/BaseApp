...
public class ErrorTips {
    ...
    public static ResponeThrowable handleException(Throwable e) {
        ...
        if (e instanceof HttpException) {
            ...
            CodeException resultException = (CodeException) e;
            ex = new ResponeThrowable(e, ERROR.FORBID_ACCESS);
            switch (resultException.getErrCode()) {
                case ERROR.FORBID_ACCESS:
                    ex = new ResponeThrowable(e, ERROR.FORBID_ACCESS);
                    ex.message = "禁止访问";
                case ERROR.FORBID_ACCESS_IP:
                    ex = new ResponeThrowable(e, ERROR.FORBID_ACCESS_IP);
                    ex.message = "IP禁止访问";
                case ERROR.ACCOUNT_NOT_EXIST:
                    ex = new ResponeThrowable(e, ERROR.ACCOUNT_NOT_EXIST);
                    ex.message = "IP禁止访问";
            }
    ...
    public static class ERROR {
         ...
         * 禁止访问
         */
        public static final int FORBID_ACCESS = 100;
        /**
         * IP禁止访问
         */
        public static final int FORBID_ACCESS_IP = 400;

        /**
         * 账号不存在
         */
        public static final int ACCOUNT_NOT_EXIST = 500;
        /**
         * 未知错误
         */
    ...
    public static class CodeException extends RuntimeException {
        ...
        public CodeException(int errCode, String msg) {
            super(msg);
